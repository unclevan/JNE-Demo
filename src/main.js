...
function dashContent(d){
  ...
  if(dashTab==='efficiency'){
    const timeAnalysis=`${chart('efficiencyTrend','efficiency-chart')}<div class="impact-latest"><div><small>近12月AI触达</small><b>22,250</b><em>人次</em></div><div><small>平均竞买人数</small><b>3.9 → 6.8</b><em>+74.4%</em></div><div><small>综合溢价率</small><b>6.4% → 8.7%</b><em>+2.3pp</em></div></div>`;
